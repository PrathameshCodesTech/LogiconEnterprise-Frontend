...
export function LoginPage() {
  ...
  return (
    <div className="login-page-static grid min-h-screen grid-cols-1 bg-brand-900 lg:grid-cols-2">
      <section
        className={cn(
          'order-2 flex flex-col justify-center bg-white px-6 py-12',
          'text-app-text lg:order-1 lg:px-10 xl:px-16',
        )}
      >
      ...
      <section
        className={cn(
          'order-1 flex flex-col justify-center bg-brand-900 px-6 py-12 sm:px-10',
          'lg:order-2 lg:py-16 xl:px-14',
        )}
      >
        <div className="mx-auto w-full max-w-md">
          <h2 className="text-2xl font-bold text-white">Welcome back</h2>
          <p className="mt-2 text-sm text-[var(--login-rail-subtle)]">
            Sign in with your organization email and password.
          </p>
          <p className="mt-1 text-xs text-[var(--login-rail-subtle)]">
